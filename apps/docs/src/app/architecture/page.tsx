    ...
    <main className="mx-auto max-w-4xl px-6 py-16 sm:px-8 sm:py-24 space-y-16">
      <header>
        ...
        <p className="mt-4 text-lg leading-relaxed text-white/60">
          How the DAG handles immutability, lineage, and spatial visualization without cognitive overload.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-white/70">
          In Glass Box, the reasoning chain is an immutable Directed Acyclic Graph (DAG). 
          When a user corrects an AI hallucination or decides to steer the LLM in a different direction, 
        ...
        <p className="text-base leading-relaxed text-white/70">
          ...
          any generated artifact can be perfectly traced back to its specific execution lineage. 
